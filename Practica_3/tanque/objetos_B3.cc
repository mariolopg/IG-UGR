...
glDrawArrays(GL_POINTS,0,vertices.size()); //Pinta puntos desde la posición 0 hasta la vertices.size() //Hacer 2 figuras que se pintan en el mismo vertex array por ejemplo cubo y esfera
...
void _triangulos3D::draw_solido(float r, float g, float b)
{
	...
	//Hacer modo solido y modo ajedrez en vertex array
int i;
...
//Tip para vertex array dos vectores de caras porq no sepueden poner colores distintos a cad cara
